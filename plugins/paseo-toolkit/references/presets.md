...
- `notes`: `사용자 요청의 단계·담당 프로필·실행 순서를 정하고 결과를 취합한다. 작업 자체는 담당 워커에게 맡긴다. 자문 호출은 사용 목적의 사용자 승인이 있을 때만 한다.`
...
- `notes`: `무엇을 만들지 불명확할 때 요구사항·범위·비범위·수용 기준을 정리한다. 사업·제품 선택은 사용자에게 확인한다. 기술 성립 여부의 검증 설계는 spike-plan.`
